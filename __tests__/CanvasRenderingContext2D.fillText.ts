...
function drawOperationExpect() {
  expect(ctx.fillText).toBeCalledWith("testing", 1, 2);
}

function drawOperation() {
  wasm.fillText(wasm.newString("testing"), 1, 2);
  wasm.commit();
}
...
describe("fillText", () => {
  ...
  it("should update the fillStyle when fillTextis called", () => {
  ...
  it("should update the shadowBlur value when fillText is called", () => {
    wasm.shadowBlur(0.5);
    drawOperation();
  ...
  it("should update the shadowColor value when fillText is called", () => {
  ...
  it("should update the shadowOffsetX value when fillText is called", () => {
  ...
  it("should update the shadowOffsetY value when fillText is called", () => {
  ...
  it("should update the textAlign value when fillText is called", () => {
  ...
  it("should update the transform value when fillText is called", () => {
