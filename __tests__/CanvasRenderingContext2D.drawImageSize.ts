...
interface ICanvasRenderingContext2DTestSuite {
  ...
  commit(): void;
  drawImagePosition(img: number, dx: number, dy: number): void;
  drawImageSize(img: number, dx: number, dy: number, dWidth: number, dHeight: number): void;
}
...
function drawOperationExpect() {
  expect(ctx.drawImage).toBeCalledWith(
    wasm.images[img],
    0, 0, wasm.images[img].width, wasm.images[img].height,
    1, 2, 3, 4,
  );
}

function drawOperation() {
  wasm.drawImageSize(img, 1, 2, 3, 4);
  wasm.commit();
}
...
describe("drawImagePosition", () => {
  it("should call drawImage", () => {
    drawOperation();
    drawOperationExpect();
  });

  it("should update the filter value when drawImagePosition is called", () => {
  ...
  it("should update the globalAlpha value when drawImagePosition is called", () => {
  ...
  it("should update the globalCompositeOperation value when drawImagePosition is called", () => {
  ...
  it("should update the imageSmoothingEnabled value when drawImagePosition is called", () => {
  ...
  it("should update the imageSmoothingQuality value to medium when drawImagePosition is called", () => {
  ...
  it("should update the imageSmoothingQuality value to high when drawImagePosition is called", () => {
  ...
  it("should not update the imageSmoothingQuality value if imageSmoothingEnabled is false when drawImagePosition is called", () => {
    wasm.imageSmoothingQuality(ImageSmoothingQuality.high);
    wasm.imageSmoothingEnabled(0);
    drawOperation();
    wasm.commit();
  ...
  it("should update the shadowBlur value when drawImagePosition is called", () => {
    wasm.shadowBlur(0.5);
    drawOperation();
    wasm.commit();
  ...
  it("should update the shadowColor value when drawImagePosition is called", () => {
  ...
  it("should update the shadowOffsetX value when drawImagePosition is called", () => {
  ...
  it("should update the shadowOffsetY value when drawImagePosition is called", () => {
  ...
  it("should update the transform value when drawImagePosition is called", () => {
